...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY29jb250dXMiLCJhIjoiY2swYjZiamdqMG91ejNjcGlmcHVldzNicSJ9.iia35em7Mli7f1WQaM_pzg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Creating account successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
  ...
  regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_6Aj1E7Xls1KwSiCNzI59eFSi00AmJr8ZqT');
            _context.prev = 1;
            _context.next = 4;
          ...
          case 4:
            ...
            console.log(); // 2) Create checkout form + charge credit card
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // button.btn.btn--green.span-all-rows#book-tour(data-..
  // ..tour-id<=> tourId
